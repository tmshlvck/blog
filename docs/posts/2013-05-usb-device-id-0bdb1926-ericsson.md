...
After some time spent with the change-logs, debugging and asking google I have found this: [https://bugs.launchpad.net/ubuntu/+source/network-manager/+bug/1172178](https://bugs.launchpad.net/ubuntu/+source/network-manager/+bug/1172178)
...
Advice from Oleg Cherkasov at the end of the ticket worked for me. Thanks!
