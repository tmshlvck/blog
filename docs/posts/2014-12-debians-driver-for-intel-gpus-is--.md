...
This blog post explains everything: [http://blogs.fsfe.org/the\_unconventional/2014/11/12/debian-x-drivers/](http://blogs.fsfe.org/the_unconventional/2014/11/12/debian-x-drivers/)
